        ...
        <div class="container">
            <div class="row d-flex align-items-center " >
                <section align="center" style="padding:20px;"  class="wow fadeInUp" >
                        ...
                        <!-- List of Clients-->
                        <div align="center" id="mobilemodetesimonial" class="carousel slide carousel-multi-item v-2 wow animated fadeInUp fast" data-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                @if($testimonials && $testimonials->count())
                                    @foreach ($testimonials as $testimonial)
                                        <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                            <div class="row">
                                                <div class="col-md-12"> {/* Changed col-md-4 to col-md-12 for full width on mobile-like view inside component */}
                                                    <div class="card mb-2">
